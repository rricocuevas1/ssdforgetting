...
```
This will create the final solution files for each one of the experiments. Each file containins the standard deviation and average of the quality and runtime for IndepDF, DepDF, LAZY-GREEDY, and QUERY-BASED-AMNESIA for the experiment described by the solution file name.
## General Usage
